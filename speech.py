...
class SpeechView(ui.View):
	...
	def table_action(sender):
		...
		if selected_lang == 'American': self.lang = 'en-US'
		if selected_lang == 'British': self.lang = 'en-GB'
		if selected_lang == 'Italian': self.lang = 'it-IT'
		if selected_lang == 'Spanish': self.lang = 'es-MX'
		if selected_lang == 'Australian': self.lang = 'en-AU'
		if selected_lang == 'Japanese': self.lang = 'ja-JP'
		if selected_lang == 'German': self.lang = 'de-DE'
		else:
			pass
